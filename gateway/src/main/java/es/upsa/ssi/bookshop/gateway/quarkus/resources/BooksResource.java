package es.upsa.ssi.bookshop.gateway.quarkus.resources;

import es.upsa.ssi.bookshop.gateway.quarkus.resources.providers.beans.ErrorMessage;
...
public class BooksResource {
    ...
    public Response getBooks() throws BookshopException {
        return Response.ok(service.requestFindBooks()).build();
    }
    ...
    public Response getBook(@Parameter(required = true,
        ...
        return Response.ok(service.requestBookById(id)).build();
    }
    ...
    public Response createBook(@RequestBody(
        ...
        Book book = service.requestCreateBook(mapper.toBook(unidentifiedBook));
    ...
    public Response updateBook(@Parameter(required = true,
        ...
        service.requestUpdateBook(mappers.toBook(unidentifiedBook).withId(id));
    ...
    @Path("{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response deleteBook(@Parameter(required = true,
                                        description = "ID Book",
                                        in = ParameterIn.PATH,
                                        name = "ID",
                                        schema = @Schema(type = SchemaType.STRING)
    )@PathParam("id") String id) throws BookshopException {
        service.requestDeleteBook(id);
        return Response.ok().build();
    }
