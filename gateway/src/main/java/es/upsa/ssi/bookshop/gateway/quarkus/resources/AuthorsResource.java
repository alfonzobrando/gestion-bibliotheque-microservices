...
public class AuthorsResource {
    ...
    public Response getAuthors() throws BookshopException {
        return Response.ok(service.requestFindAuthors()).build();
    }
    ...
    public Response getAuthor(@Parameter(required = true,
        ...
        return Response.ok(service.requestAuthorById(id)).build();
    }
    ...
    public Response createAuthor(@RequestBody(
        ...
        Author author = service.requestCreateAuthor(mapper.toAuthor(unidentifiedAuthor));
    ...
    public Response updateAuthor(@Parameter(required = true,
        ...
        service.requestUpdateAuthor(mappers.toAuthor(unidentifiedAuthor).withId(id));
    ...
    public Response deleteAuthor(@Parameter(required = true,
        ...
        service.requestDeleteAuthor(id);
        return Response.ok().build();
    }
